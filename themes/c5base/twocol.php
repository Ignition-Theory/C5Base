<?php  defined('C5_EXECUTE') or die("Access Denied."); ?> <?php $this->inc('elements/html_head.php'); ?> <div class="container pageContainer"> <?php $this->inc('elements/page_header.php'); ?> <div class=pageBody> <div class=row-fluid> <div class=span12> <section class=areaMain> <?php 
					$a = new Area('Header');
					...
					$a->display($c);
					?> </section> </div> </div> <div class=row-fluid> <div class=span6> <section class=areaMain> <?php 
					$a = new Area('Main');
					$a->setCustomTemplate('autonav','c5base_theme.php');
					$a->setCustomTemplate('content','c5base_theme.php');
					$a->setCustomTemplate('image','c5base_theme.php');
