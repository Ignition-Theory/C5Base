...
/* 	BREADCRUMBS
   	==========================================================================
	Displays a breadcrumb menu using the Twitter Bootstrap Breadcrumb component (http://twitter.github.com/bootstrap/components.html#breadcrumbs)
...
echo '<nav><ul class="breadcrumb">'; //opens the top-level menu
...
foreach ($navItems as $ni) {
	...
	if ($ni->isEnabled) {
		echo '<a href="' . $ni->url . '" target="' . $ni->target . '" class="' . $ni->anchorClasses . '">' . $ni->name . '</a><span class="divider">/</span>';
	} else {
		echo '<span class="' . $ni->anchorClasses . '">' . $ni->name . '</span><span class="divider">/</span>';
	}
